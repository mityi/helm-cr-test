...
cr index --owner mityi --git-repo helm-cr-test --package-path ./release-helm/.deploy --index-path ./docs/index.yaml --charts-repo https://github.com/mityi/helm-cr-test --token 
```